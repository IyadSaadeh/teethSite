      ...
      <div className="container">
        <div className="row align-items-center">
              ...
              <ul>
                <li>
                  <img
                    ...
                    src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2Fpic-1.ad1ed7ee.jpg?alt=media&token=c75fa498-c802-478d-91f1-97c623809692"
                    alt="icon"
                  ></img>
                </li>
                <li>
                  <img
                    ...
                    src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2Fpic-2.0593bc2f.jpg?alt=media&token=11a9c7ec-a225-4dea-8740-2a0ecf9286c9"
                    alt="icon"
                  ></img>
                </li>
                <li>
                  <img
                    ...
                    src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2Fpic-3.fa689b10.jpg?alt=media&token=d7f368e7-c06d-46c1-8d35-5b594cce9bbb"
                    alt="icon"
                  ></img>
                </li>
                <li>
          ...
          <div className="col-lg-6 mb-30">
            ...
            <Link className="btn btn-primary shadow" href="/">
              Read More
            </Link>
          </div>
        </div>
      </div>
      <img className="pt-img1 animate-wave" src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2F8.png?alt=media&token=91dd2063-f5d5-4d40-99a5-ddd6eaa2775a" alt="icon" ></img>
      <img className="pt-img2 animate2" src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2F9.png?alt=media&token=3e54c54d-4f6a-42fc-a060-e6d7627a66b6" alt="icon" ></img>
      <img className="pt-img3 animate-rotate" src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2F10.png?alt=media&token=fa4302c4-7eef-45b6-aa42-608d12dfd00b" alt="icon" ></img>
      <img className="pt-img4 animate-wave" src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2F11.png?alt=media&token=3fc041de-53c1-468d-9162-692499def906" alt="icon" ></img>
      <img className="pt-img5 animate2" src="https://firebasestorage.googleapis.com/v0/b/e-comerce1.appspot.com/o/img%20site%20zaid%2F10.png?alt=media&token=fa4302c4-7eef-45b6-aa42-608d12dfd00b" alt="icon" ></img>
    </section>
  );
};
